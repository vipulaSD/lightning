...
def test_wandb_logger_init(wandb, monkeypatch):
    ...
    monkeypatch.setattr(pytorch_lightning.loggers.wandb, "_is_wandb_greater_equal_0_12_10", lambda: True)
...
def test_wandb_log_model(wandb, monkeypatch, tmpdir):
    ...
    monkeypatch.setattr(pytorch_lightning.loggers.wandb, "_is_wandb_greater_equal_0_10_22", lambda: True)
